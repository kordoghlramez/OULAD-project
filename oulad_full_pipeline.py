...
if __name__ == '__main__':
    ...
    # Step 5 — Save outputs
    master.to_csv(r'C:\Users\kordo\Desktop\master_clean.csv', index=False)
    df_info.to_csv(r'C:\Users\kordo\Desktop\studentInfo_clean.csv', index=False)
    df_reg.to_csv(r'C:\Users\kordo\Desktop\studentRegistration_clean.csv', index=False)
    df_assessments.to_csv(r'C:\Users\kordo\Desktop\assessments_clean.csv', index=False)
    df_sa_raw.to_csv(r'C:\Users\kordo\Desktop\studentAssessment_clean.csv', index=False)
    df_sa_agg.to_csv(r'C:\Users\kordo\Desktop\studentAssessment_aggregated.csv', index=False)
    df_vle_agg.to_csv(r'C:\Users\kordo\Desktop\studentVle_aggregated.csv', index=False)
    df_courses.to_csv(r'C:\Users\kordo\Desktop\courses_clean.csv', index=False)
